...
Pod::Spec.new do |s|
  ...
  s.version          = '1.0.0'
  s.summary          = 'A short description of SwiftStarRatting.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/87113814/SwiftStarRatting'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '87113814' => 'narendra.singh@mindinventory.com' }
  s.source           = { :git => 'https://github.com/87113814/SwiftStarRatting.git', :tag => s.version.to_s }
